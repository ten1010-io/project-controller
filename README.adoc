...
# example: git checkout tags/aipub-3
----
...
+
아래 예제는 au1(project-manager)과 au2(project-developer)를 구성원으로 두고, node1 노드와 ng1 노드 그룹, img-hub1 이미지 허브를 연결하며, PVC 스토리지 할당량을 500Gi로 지정한 프로젝트입니다.
