...
public abstract class K8sObjectUtils {
  ...
  public static V1OwnerReference buildV1OwnerReference(KubernetesObject parentObject,
      boolean controller, boolean blockOwnerDeletion) {
  ...
  public static <T extends KubernetesObject> List<T> distinctByKey(KeyResolver keyResolver,
      List<T> objects) {
