...
import static io.ten1010.aipub.projectcontroller.mutating.AipubAdmissionReviewController.PATH;
...
@RestController
@RequestMapping(PATH)
public class AipubAdmissionReviewController {

  public static final String PATH = "/api/v1/userrelationship/mutate";

  private final List<ReviewHandler> reviewHandlers;

  public AipubAdmissionReviewController(
      @Qualifier("aipubReviewHandlers") List<ReviewHandler> reviewHandlers) {
  ...
  public ResponseEntity<V1AdmissionReview> create(@RequestBody V1AdmissionReview review) {
    log.debug("Aipub admission review request received");
