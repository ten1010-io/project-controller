...
import static io.ten1010.aipub.projectcontroller.mutating.UserAuthorityReviewMutateController.PATH;
...
@RestController
@RequestMapping(PATH)
public class UserAuthorityReviewMutateController {

  public static final String PATH = "/api/v1/userauthorityreview/mutate";

  private final UserAuthorityReviewMutateHandler handler;

  public UserAuthorityReviewMutateController(UserAuthorityReviewMutateHandler handler) {
    this.handler = handler;
  }

  @PostMapping(value = "", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<V1AdmissionReview> create(@RequestBody V1AdmissionReview review) {
    log.debug("UserAuthorityReview mutate request received");
