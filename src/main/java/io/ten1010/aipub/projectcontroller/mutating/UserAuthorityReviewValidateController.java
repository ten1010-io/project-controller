...
import static io.ten1010.aipub.projectcontroller.mutating.UserAuthorityReviewValidateController.PATH;
...
@RestController
@RequestMapping(PATH)
public class UserAuthorityReviewValidateController {

  public static final String PATH = "/api/v1/userauthorityreview/validate";

  private final UserAuthorityReviewValidateHandler handler;

  public UserAuthorityReviewValidateController(UserAuthorityReviewValidateHandler handler) {
    this.handler = handler;
  }

  @PostMapping(value = "", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<V1AdmissionReview> create(@RequestBody V1AdmissionReview review) {
    log.debug("UserAuthorityReview validate request received");
