...
public class WorkloadControllerReconciler extends AbstractReconciler {
    ...
    protected Result reconcileInternal(Request request) throws ApiException {
        ...
        List<V1LocalObjectReference> reconciledImagePullSecrets = this.reconciliationService.reconcileImagePullSecrets(templateSpec, project);

        return this.controllerObjectReconciler.reconcileController(controller, reconciledTolerations, reconciledSelectorTerms, reconciledImagePullSecrets);
    }
