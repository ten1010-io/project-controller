...
public class ClusterRoleControllerFactory implements ControllerFactory {
  ...
  private ControllerWatch<V1alpha1ResourceSet> createResourceSetWatch(
      WorkQueue<Request> workQueue) {
    DefaultControllerWatch<V1alpha1ResourceSet> watch = new DefaultControllerWatch<>(workQueue,
