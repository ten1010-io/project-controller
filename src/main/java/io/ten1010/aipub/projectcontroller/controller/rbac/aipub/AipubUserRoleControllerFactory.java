...
public class AipubUserRoleControllerFactory implements ControllerFactory {
  ...
  private ControllerWatch<V1beta1Workspace> createV1beta1WorkspaceWatch(
      WorkQueue<Request> workQueue) {
    DefaultControllerWatch<V1beta1Workspace> watch = new DefaultControllerWatch<>(workQueue,
        V1beta1Workspace.class);
    watch.setOnUpdateFilter(this.onUpdateFilterFactory.v1beta1WorkspaceFilter());
    watch.setRequestBuilder(this.requestBuilderFactory.v1beta1WorkspaceToAipubUserRoles());
    return watch;
  }
