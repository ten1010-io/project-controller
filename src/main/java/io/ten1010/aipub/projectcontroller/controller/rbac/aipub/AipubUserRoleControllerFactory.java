...
public class AipubUserRoleControllerFactory implements ControllerFactory {
    ...
    public Controller createController() {
        return ControllerBuilder.defaultBuilder(this.sharedInformerFactory)
                ...
                .withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1Workspace.class)::hasSynced)
                .withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1alpha1AipubJob.class)::hasSynced)
                .withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1alpha1Operation.class)::hasSynced)
                .withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1alpha1AipubVolume.class)::hasSynced)
                .withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1alpha1SftpServer.class)::hasSynced)
                .withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1FtpServer.class)::hasSynced)
                ...
                .withReconciler(new AipubUserRoleReconciler(this.sharedInformerFactory, this.k8sApiProvider, this.reconciliationService))
                .build();
    }
    ...
    private ControllerWatch<V1Workspace> createWorkspaceWatch(WorkQueue<Request> workQueue) {
        DefaultControllerWatch<V1Workspace> watch = new DefaultControllerWatch<>(workQueue, V1Workspace.class);
    ...
    private ControllerWatch<V1alpha1AipubJob> createAipubJobWatch(WorkQueue<Request> workQueue) {
        DefaultControllerWatch<V1alpha1AipubJob> watch = new DefaultControllerWatch<>(workQueue, V1alpha1AipubJob.class);
        watch.setOnUpdateFilter(this.onUpdateFilterFactory.alwaysTrueFilter());
    ...
    private ControllerWatch<V1alpha1Operation> createOperationWatch(WorkQueue<Request> workQueue) {
        DefaultControllerWatch<V1alpha1Operation> watch = new DefaultControllerWatch<>(workQueue, V1alpha1Operation.class);
        watch.setOnUpdateFilter(this.onUpdateFilterFactory.alwaysTrueFilter());
        watch.setRequestBuilder(this.requestBuilderFactory.operationToAipubUserRoles());
        return watch;
    }

    private ControllerWatch<V1alpha1AipubVolume> createAipubVolumeWatch(WorkQueue<Request> workQueue) {
        DefaultControllerWatch<V1alpha1AipubVolume> watch = new DefaultControllerWatch<>(workQueue, V1alpha1AipubVolume.class);
        watch.setOnUpdateFilter(this.onUpdateFilterFactory.alwaysTrueFilter());
    ...
    private ControllerWatch<V1alpha1SftpServer> createSftpServerWatch(WorkQueue<Request> workQueue) {
        DefaultControllerWatch<V1alpha1SftpServer> watch = new DefaultControllerWatch<>(workQueue, V1alpha1SftpServer.class);
        watch.setOnUpdateFilter(this.onUpdateFilterFactory.alwaysTrueFilter());
    ...
    private ControllerWatch<V1FtpServer> createFtpServerWatch(WorkQueue<Request> workQueue) {
        DefaultControllerWatch<V1FtpServer> watch = new DefaultControllerWatch<>(workQueue, V1FtpServer.class);
        watch.setOnUpdateFilter(this.onUpdateFilterFactory.alwaysTrueFilter());
