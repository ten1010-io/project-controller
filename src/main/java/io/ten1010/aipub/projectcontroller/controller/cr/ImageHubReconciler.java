...
public class ImageHubReconciler extends AbstractReconciler {
    ...
    protected Result reconcileInternal(Request request) throws ApiException {
        ...
        Optional<V1alpha1ImageHub> imageHubOpt = Optional.ofNullable(this.imageHubIndexer.getByKey(imageHubKey));
    ...
    private Result reconcileExistingImageHub(V1alpha1ImageHub existing, V1alpha1ImageHubStatus reconciledStatus) throws ApiException {
