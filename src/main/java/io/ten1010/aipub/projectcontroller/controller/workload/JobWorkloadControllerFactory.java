...
public class JobWorkloadControllerFactory extends WorkloadControllerFactory {
    ...
    protected void configureReadyFunc() {
        this.builder.withReadyFunc(this.sharedInformerFactory.getExistingSharedIndexInformer(V1Job.class)::hasSynced);
    ...
    protected ControllerObjectReconciler getObjectReconciler() {
        return (KubernetesObject controller,
            ...
            return this.reconcileController(job, reconciledTolerations, reconciledSelectorTerms, reconciledImagePullSecrets);
        };
    }
