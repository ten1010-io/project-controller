...
public class RoleBindingReconciler extends AbstractReconciler {
  ...
  protected Result reconcileInternal(Request request) throws ApiException {
    ...
    Optional<V1RoleBinding> roleBindingOpt = Optional.ofNullable(
        this.RoleBindingIndexer.getByKey(roleBindingKey));
    ...
    V1RoleRef reconciledRoleRef = this.reconciliationService.reconcileRoleRef(projectOpt.get(),
        projRoleEnum);
    ...
    if (roleBindingOpt.isPresent()) {
      ...
      String projNameFromNamespace = this.namespaceNameResolver.resolveProjectName(
  ...
  private Result reconcileExistingRoleBinding(
    ...
    if (Set.copyOf(K8sObjectUtils.getOwnerReferences(roleBinding))
