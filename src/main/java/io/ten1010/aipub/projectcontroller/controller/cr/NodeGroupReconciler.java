...
public class NodeGroupReconciler extends AbstractReconciler {
  ...
  protected Result reconcileInternal(Request request) throws ApiException {
    ...
    Optional<V1alpha1NodeGroup> nodeGroupOpt = Optional.ofNullable(
        this.nodeGroupIndexer.getByKey(nodeGroupKey));
    ...
    V1alpha1NodeGroupStatus reconciledStatus = this.reconciliationService.reconcileNodeGroupStatus(
        nodeGroup, boundProjects, boundNodes);

    return reconcileExistingNodeGroup(nodeGroupOpt.get(), reconciledStatus);
  }

  private Result reconcileExistingNodeGroup(V1alpha1NodeGroup nodeGroup,
      V1alpha1NodeGroupStatus reconciledStatus) throws ApiException {
  ...
  private void updateNodeGroupStatus(V1alpha1NodeGroup nodeGroup) throws ApiException {
    ...
    this.statusPatchHelper.patchStatus(null, K8sObjectUtils.getName(nodeGroup),
        nodeGroup.getStatus());
  }
